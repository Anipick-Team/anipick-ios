//
//  StarRatingComponentView 2.swift
//  AniPick
//
//  Created by cho on 12/18/25.
//


import SwiftUI

struct StarRatingComponentView2: View {
    ...
    init(starRating: Binding<Double>, fontSize: CGFloat, fontColor: Color, starSize: CGFloat, action: @escaping (Double) -> Void) {
